...
export const UI_STRINGS = {
    ...
    arena: {
        ...
        active_persona: 'Active Customer Persona',
        crafting_persona: 'Crafting persona...',
        start_simulation: 'Start Simulation',
        mission_debrief: 'Mission Debrief',
        analyzing_session: 'Analyzing Session...',
        calculating_score: 'Gemini 2.5 is calculating your score.',
        scoring: 'Scoring...',
        cultural_iq: 'Cultural IQ',
        next_mission: 'Next Mission',
        ready_to_train: 'Ready to Train',
        speak_naturally: 'Speak naturally. AI is listening.',
        practice_skills: 'Practice your skills.',
        adjusting: 'Adjusting...',
    },
};
